...
public class WeaponTracer {
    ...
    public static void Create(Vector3 fromPosition, Vector3 targetPosition) {
        ...
        tracerMaterial.SetTextureScale("_MainTex", new Vector2(1f, distance / (256f/32f)));
        World_Mesh worldMesh = new World_Mesh(null, spawnTracerPosition, new Vector3(1f, 1f), shootAngle - 90, 0.5f, distance, tracerMaterial, null, 10000);
